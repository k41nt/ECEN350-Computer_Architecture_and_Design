...
LAB2:    xsi_set_current_line(13, ng0);
    ...
    *((unsigned int *)t16) = t25;
    xsi_vlog_mul_concat(t14, 38, 1, t15, 1U, t18, 1);
    xsi_vlogtype_concat(t4, 64, 64, 2U, t14, 38, t5, 26);
    t26 = (t0 + 5552);
    if (*((int *)t26) > 0)
        goto LAB4;
...
LAB2:    xsi_set_current_line(18, ng0);
    ...
    *((unsigned int *)t16) = t25;
    ...
    xsi_vlogtype_concat(t4, 64, 64, 2U, t14, 45, t5, 19);
    t26 = (t0 + 5556);
    if (*((int *)t26) > 0)
        goto LAB4;
...
extern void work_m_00000000003326379025_2412880366_init()
{
	...
	xsi_register_didat("work_m_00000000003326379025_2412880366", "isim/SingleCycleProcTest_v_isim_beh.exe.sim/work/m_00000000003326379025_2412880366.didat");
